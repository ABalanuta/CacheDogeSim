...
LOCALVAR UL2::CACHE ul2_01("L2 Core 0-1 Cache", UL2::cacheSize, UL2::lineSize, UL2::associativity);
LOCALVAR UL2::CACHE ul2_23("L2 Core 2-3 Cache", UL2::cacheSize, UL2::lineSize, UL2::associativity);
